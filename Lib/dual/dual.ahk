class Dual {
	...
	settings := {delay: 5, timeout: -1, doublePress: 200, specificDelays: false}
	...
	allModifiers := ["LShift", "RShift", "LCtrl", "RCtrl", "LAlt", "RAlt", "LWin", "RWin", "F13", "F14", "F15", "F16", "F17", "F18", "F19", "F20", "F21", "F23", "F24"]  ; F22 omitted to preserve autospacing setting
	reset() {
		this.keys := {}
