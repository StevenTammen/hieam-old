...
; ======================================================================
; Set Up Library Hooks: From virtual-desktop-enhancer.ahk
; ======================================================================
...
GetAllWindows()
{
  global switcher_id, filters
  windows := Object()
  currentDesktopNo := _GetCurrentDesktopNumber() ; (Added)
  ...
  Loop, %id%
  {
    ...
    windowID := % id%A_Index%
    windowIsOnDesktop := DllCall(IsWindowOnDesktopNumberProc, UInt, windowID, UInt, currentDesktopNo)
